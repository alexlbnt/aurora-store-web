...
export default function DeleteButton({ orderId }: { orderId: string }) {
  ...
  return (
    <button 
      ...
      disabled={isPending}
      className="text-slate-400 hover:text-rose-600 transition-colors p-1.5 rounded hover:bg-rose-50 dark:hover:bg-rose-900/20 inline-block disabled:opacity-50" 
